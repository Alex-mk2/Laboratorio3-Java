...
public class Main{
        ...
        do {
            ...
            switch (choice) {
                ...
                case 1:
                    ...
                    //Se crean pixbit, pixrgb y pixhex para verificar su funcionamiento
                    ...
                    List<TDA_Pixel_MelladoAlex_19684813> Pixeleslist = new ArrayList<>(); //Se crea una lista de pixeles para almacenarlos
                    ...
                    TDA_Imagen_MelladoAlex_19684813 Hexmap = new TDA_Imagen_MelladoAlex_19684813(2, 2, Pixeleslist);
                    TDA_Imagen_MelladoAlex_19684813 pixmap = new TDA_Imagen_MelladoAlex_19684813(2, 2, Pixeleslist);
                    ...
                    pixmap.isPixmap(); //Aqui se hace el llamado a las 3 pertenencias para verificar su funcionamiento
                    //Se imprime todo por pantalla para cada tipo de pixel
    ...
    private static void printMenu() {
        ...
        System.out.print("3. Mostrar una imagen .\n");
